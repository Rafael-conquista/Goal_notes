...
class AmigosModel(banco.Model):
    ...
    id_usuario_enviado = banco.Column(banco.Integer, ForeignKey("Users.id"), unique=False)
    id_usuario_recebido = banco.Column(banco.Integer, ForeignKey("Users.id"), unique=False)
